...
users = [
    {'login': 'alex', 'password': '123', 'name': 'Алексей Алексеевич', 'gender': 'м'},
    {'login': 'bob', 'password': '555', 'name': 'Боб Бобович', 'gender': 'м'},
    {'login': 'dan', 'password': '111', 'name': 'Денис Денисович', 'gender': 'м'},
    {'login': 'abc', 'password': '444', 'name': 'Анастасия Алексеевна', 'gender': 'ж'}
]
